...
in Austria from the beginning of 2000 to the end of 2020. The data is provided in the
...
zero in the thousands, i.e., a model for count data will most probably not improve the overall fit.
...
mortality rate from 2020 is plotted in red and clearly
...
**Note:** Previous versions of the package, in particular the one used in
@bamlss:Umlauf+bamlss:2021, employed a slightly smaller version of the data
