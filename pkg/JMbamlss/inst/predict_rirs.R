...
ndat_es$fit_RE <- predict(b_rirs, ndat_es, model = "mu")
...
# True FPCs
tru1 <- ggplot(data = ndat_tru %>% filter(id %in% id1), 
  ...
  ggtitle("True FPCs")
tru2 <- ggplot(data = ndat_tru %>% filter(id %in% id2), 
               aes(x = obstime, colour = id)) +
  theme_bw(base_size = 22) +
  geom_line(aes(y = fit)) +
  geom_line(aes(y = mu), linetype = "dashed") +
  ...
  facet_wrap(~marker, scales = "free") +
  ggtitle("True FPCs")
tru3 <- ggplot(data = ndat_tru %>% filter(id %in% id3), 
               aes(x = obstime, colour = id)) +
  theme_bw(base_size = 22) +
  geom_line(aes(y = fit)) +
  geom_line(aes(y = mu), linetype = "dashed") +
...
# True FPCs with RI
tru_ri1 <- ggplot(data = ndat_tru %>% filter(id %in% id1), 
               aes(x = obstime, colour = id)) +
  theme_bw(base_size = 22) +
  geom_line(aes(y = fit_RE)) +
  geom_line(aes(y = mu), linetype = "dashed") +
  geom_point(data = d_1_obs %>% filter(id %in% id1), 
             aes(y = y, shape = id), size = 2) +
  theme(legend.position = "none") +
  ...
  scale_x_continuous("Time") +
  facet_wrap(~marker, scales = "free") +
  ggtitle("True FPCs with RI")
tru_ri2 <- ggplot(data = ndat_tru %>% filter(id %in% id2), 
               aes(x = obstime, colour = id)) +
  theme_bw(base_size = 22) +
  geom_line(aes(y = fit_RE)) +
  geom_line(aes(y = mu), linetype = "dashed") +
  ...
  facet_wrap(~marker, scales = "free") +
  ggtitle("True FPCs with RI")
tru_ri3 <- ggplot(data = ndat_tru %>% filter(id %in% id3), 
               aes(x = obstime, colour = id)) +
  theme_bw(base_size = 22) +
  geom_line(aes(y = fit_RE)) +
  geom_line(aes(y = mu), linetype = "dashed") +
...
# Estimated FPCs
est1 <- ggplot(data = ndat_es %>% filter(id %in% id1), 
               aes(x = obstime, colour = id)) +
  theme_bw(base_size = 22) +
  geom_line(aes(y = fit)) +
  geom_line(aes(y = mu), linetype = "dashed") +
  ...
  facet_wrap(~marker, scales = "free") +
  ggtitle("Est FPCs")
est2 <- ggplot(data = ndat_es %>% filter(id %in% id2), 
               aes(x = obstime, colour = id)) +
  theme_bw(base_size = 22) +
  geom_line(aes(y = fit)) +
  geom_line(aes(y = mu), linetype = "dashed") +
  ...
  facet_wrap(~marker, scales = "free") +
  ggtitle("Est FPCs")
est3 <- ggplot(data = ndat_es %>% filter(id %in% id3), 
               aes(x = obstime, colour = id)) +
  theme_bw(base_size = 22) +
  geom_line(aes(y = fit)) +
  geom_line(aes(y = mu), linetype = "dashed") +
...
# True RI
re1 <- ggplot(data = ndat_es %>% filter(id %in% id1), 
                  aes(x = obstime, colour = id)) +
  theme_bw(base_size = 22) +
  geom_line(aes(y = fit_RE)) +
  geom_line(aes(y = mu), linetype = "dashed") +
  ...
  facet_wrap(~marker, scales = "free") +
  ggtitle("True RIRS")
re2 <- ggplot(data = ndat_es %>% filter(id %in% id2), 
                  aes(x = obstime, colour = id)) +
  theme_bw(base_size = 22) +
  geom_line(aes(y = fit_RE)) +
  geom_line(aes(y = mu), linetype = "dashed") +
  ...
  facet_wrap(~marker, scales = "free") +
  ggtitle("True RIRS")
re3 <- ggplot(data = ndat_es %>% filter(id %in% id3), 
                  aes(x = obstime, colour = id)) +
  theme_bw(base_size = 22) +
  geom_line(aes(y = fit_RE)) +
  geom_line(aes(y = mu), linetype = "dashed") +
